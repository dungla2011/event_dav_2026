...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Secret thanh toán từ .env (2026-09-14). Đặt ở đây vì chạy sau khi .env đã load,
        // trong khi app/common.php nạp qua composer autoload TRƯỚC đó. Các class const
        // (BaoKimAPI2021::API_KEY, clsMomo::$serectkey...) tham chiếu các hằng này.
        defined('DEF_BAOKIM_API_KEY')    || define('DEF_BAOKIM_API_KEY',    env('BAOKIM_API_KEY', ''));
        defined('DEF_BAOKIM_API_SECRET') || define('DEF_BAOKIM_API_SECRET', env('BAOKIM_API_SECRET', ''));
        defined('DEF_MOMO_PARTNER_CODE') || define('DEF_MOMO_PARTNER_CODE', env('MOMO_PARTNER_CODE', ''));
        defined('DEF_MOMO_ACCESS_KEY')   || define('DEF_MOMO_ACCESS_KEY',   env('MOMO_ACCESS_KEY', ''));
        defined('DEF_MOMO_SECRET_KEY')   || define('DEF_MOMO_SECRET_KEY',   env('MOMO_SECRET_KEY', ''));
