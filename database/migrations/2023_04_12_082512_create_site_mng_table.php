...
class CreateSiteMngTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('site_mng', function (Blueprint $table) {
            $table->integer('id', true);
            $table->integer('userid')->nullable();
            $table->string('domain', 128)->unique('domain');
            $table->string('domain1', 100)->nullable()->index('domain1');
            $table->string('domain2', 100)->nullable()->index('domain2');
            ...
            $table->integer('cache_time_minute')->nullable()->default(0);
            $table->integer('cache_disable_to_time')->nullable()->default(0);
            ...
            $table->integer('useMetaReserveOfData')->nullable();
            $table->integer('useMetaReserveOfNews')->nullable();
            $table->integer('maxSizeUploadWebMB')->nullable()->default(10);
        });
    }
