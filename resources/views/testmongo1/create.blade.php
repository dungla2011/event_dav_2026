...
@section('title', 'Create New TestMongo1')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-plus"></i> Create New TestMongo1 Record
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('testmongo1.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
                    @csrf
