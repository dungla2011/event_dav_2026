...
{{--            <a target="_blank" href="//4share.download"> <i class="fa fa-download"> </i> Trang download Tổng hợp</a>--}}
        ...
        ?>
        <div class="marquee-text1" style="color: red; text-align: center">
            <?php
            echo $ui->extra_info;
                echo  $ui->content;
            ?>
        ...
        <div class="container-fluid" style="background-color: orange ; padding: 0px">
            <div class="container" style="padding: 0px; position: relative; height: 40px"
                ...
                <?php
                    ...
                    $obj = new \App\Components\U4sHelper($uid);
//                    if($obj->isVip())
                    if(0)
                    {
                    ?>
                    <form action="/search-file" style="position: absolute; right: 0px;">
                        <input data-code-pos='ppp17364693501'
                               ...
                               class="search-top" style="" type="text"/>
                        <button type="submit" class="search-top" style="">
        ...
        <div class="row gy-6 gy-lg-0">
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    ...
                    <p class="mb-4">© <?php echo date("Y") ?> 4Share.vn <br class="d-none d-lg-block"/>All rights
                        reserved.</p>
